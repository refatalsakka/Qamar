...
// PUG_DEBUG:21
 ?>    <link<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['href' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('href', $GLOBALS['__jpv_plus_with_ref']($cssAdmin, 'users/users.css'))], ['rel' => 'stylesheet'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:401
 ?>          <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'filter'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(343);
// PUG_DEBUG:343
 ?><span<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'filter-icon'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:342
 ?><i<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'fas'], ['class' => 'fa-chevron-down'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></i></span><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(400);
// PUG_DEBUG:400
 ?>            <form<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['action' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('action', $GLOBALS['__jpv_plus_with_ref']($host, '/admin/users/filter'))], ['method' => 'GET'], ['autocomplete' => 'off'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:367
 ?>                <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-group'], ['class' => 'col-md-2'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(345);
// PUG_DEBUG:345
 ?>                  <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'col-form-label'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:366
 ?>                  <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'col-form-label'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(349);
// PUG_DEBUG:349
 ?>                    <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check'], ['class' => 'form-check-inline'], ['class' => 'mr-1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(346);
// PUG_DEBUG:346
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-input'], ['id' => 'active-checkbox'], ['type' => 'checkbox'], ['name' => 'active'], ['value' => '1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(348);
// PUG_DEBUG:348
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-label'], ['for' => 'active-checkbox'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:350
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-input'], ['id' => 'pending-checkbox'], ['type' => 'checkbox'], ['name' => 'pending'], ['value' => '1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(352);
// PUG_DEBUG:352
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-label'], ['for' => 'pending-checkbox'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:354
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-input'], ['id' => 'inactive-checkbox'], ['type' => 'checkbox'], ['name' => 'inactive'], ['value' => '1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(356);
// PUG_DEBUG:356
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-label'], ['for' => 'inactive-checkbox'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:358
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-input'], ['id' => 'online-checkbox'], ['type' => 'checkbox'], ['name' => 'online'], ['value' => '1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(360);
// PUG_DEBUG:360
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-label'], ['for' => 'online-checkbox'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:362
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-input'], ['id' => 'offline-checkbox'], ['type' => 'checkbox'], ['name' => 'offline'], ['value' => '1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(364);
// PUG_DEBUG:364
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-check-label'], ['for' => 'offline-checkbox'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:375
 ?>                  <select<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['class' => 'gender-select'], ['name' => 'gender'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(370);
// PUG_DEBUG:370
 ?>                    <option<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['value' => '0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></option>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(372);
// PUG_DEBUG:372
 ?>                    <option<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['value' => 'male'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:374
 ?>                    <option<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['value' => 'female'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:379
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['class' => 'zip'], ['type' => 'number'], ['name' => 'zip'], ['placeholder' => 'ZIP'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                </div>
<?php 
...
// PUG_DEBUG:387
 ?>                  <select<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['class' => 'country-select'], ['name' => 'country'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:386
 ?><?php $__eachScopeVariables = ['country' => isset($country) ? $country : null];foreach ($countries as $country) { ?><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(385);
// PUG_DEBUG:385
 ?>                    <option<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['value' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('value', (isset($country) ? $country : null))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(384);
// PUG_DEBUG:384
 ?><?= htmlspecialchars((is_bool($_pug_temp = (isset($country) ? $country : null)) ? var_export($_pug_temp, true) : $_pug_temp)) ?></option>
<?php }extract($__eachScopeVariables); ?>                  </select>
                </div>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(396);
// PUG_DEBUG:396
 ?>                <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-group'], ['class' => 'col-md-4'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:392
 ?>                    <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'col-md-6'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(391);
// PUG_DEBUG:391
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['class' => 'register-from'], ['type' => 'text'], ['name' => 'registration_from'], ['placeholder' => 'from'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></div>
<?php 
...
// PUG_DEBUG:393
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['class' => 'register-to'], ['type' => 'text'], ['name' => 'registration_to'], ['placeholder' => 'to'], ['disabled' => true])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></div>
                  </div>
                </div>
              </div>
<?php 
...
// PUG_DEBUG:399
 ?>              <button<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'btn'], ['class' => 'btn-secondary'], ['class' => 'mb-1'], ['type' => 'submit'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:468
 ?>          <table<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'table'], ['class' => 'table-responsive-sm'], ['class' => 'table-hover'], ['class' => 'table-outline'], ['class' => 'mb-0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(419);
// PUG_DEBUG:419
 ?>            <thead<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'thead-light'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:404
 ?>                <th<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'tr-id'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(403);
// PUG_DEBUG:403
 ?>                  <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'md-form'], ['class' => 'search-input'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(402);
// PUG_DEBUG:402
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'idInput'], ['type' => 'text'], ['placeholder' => 'ID'], ['aria-label' => 'Search'], ['autocomplete' => 'off'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></div>
                </th>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(406);
// PUG_DEBUG:406
 ?>                <th<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(405);
// PUG_DEBUG:405
 ?><i<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'icon-people'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></i></th>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(409);
// PUG_DEBUG:409
 ?>                <th<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'tr-users'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:407
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'userInput'], ['type' => 'text'], ['placeholder' => 'User'], ['aria-label' => 'Search'], ['autocomplete' => 'off'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></div>
                </th>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(411);
// PUG_DEBUG:411
 ?>                <th<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'], ['class' => 'tr-country'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:413
 ?>                <th<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'], ['class' => 'tr-zip'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:415
 ?>                <th<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'], ['class' => 'tr-status'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:423
 ?>                <td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'], ['class' => 'user-id'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:432
 ?>                <td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(431);
// PUG_DEBUG:431
 ?>                  <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'avatar'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:427
 ?><img<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'img-avatar'], ['src' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('src', $GLOBALS['__jpv_plus_with_ref']($imgDir, $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'img')))], ['alt' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('alt', $GLOBALS['__jpv_plus']($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'fname'), ' ', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'lname')))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:428
 ?><span<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'avatar-status'], ['class' => 'badge-success'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></span><?php } else { ?><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(430);
// PUG_DEBUG:430
 ?><span<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'avatar-status'], ['class' => 'badge-danger'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></span><?php } ?>                  </div>
                </td>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(444);
// PUG_DEBUG:444
 ?>                <td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'user-name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:435
 ?><a<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['href' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('href', $GLOBALS['__jpv_plus_with_ref']($host, '/admin/users/', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'id')))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:434
 ?><?= htmlspecialchars((is_bool($_pug_temp = $GLOBALS['__jpv_plus']($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'fname'), ' ', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'lname'))) ? var_export($_pug_temp, true) : $_pug_temp)) ?></a></div>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(443);
// PUG_DEBUG:443
 ?>                  <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'small'], ['class' => 'text-muted'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(440);
// PUG_DEBUG:440
 ?><?php if (method_exists($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'new'), "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php 
...
// PUG_DEBUG:442
 ?><?= htmlspecialchars((is_bool($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'registration')) ? var_export($_pug_temp, true) : $_pug_temp)) ?>                  </div>
                </td>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(447);
// PUG_DEBUG:447
 ?>                <td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'], ['class' => 'user-country'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(446);
// PUG_DEBUG:446
 ?><?php if (method_exists($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'country_icon'), "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(445);
// PUG_DEBUG:445
 ?><i<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'flag-icon'], ['class' => 'h4'], ['class' => 'mb-0'], ['title' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('title', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'country'))], ['class' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('class', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'country_icon'))], ['data-country' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('data-country', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'country'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></i><?php } ?>                </td>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(449);
// PUG_DEBUG:449
 ?>                <td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'], ['class' => 'user-zip'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:459
 ?>                <td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'text-center'], ['class' => 'user-status'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:451
 ?><span<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'badge'], ['class' => 'badge-danger'], ['data-status' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('data-status', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'status'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:454
 ?><span<?= (is_bool($_pug_temp = $pugModule['Phug\Formatter\Format\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'badge'], ['class' => 'badge-warning'], ['data-status' => $pugModule['Phug\Formatter\Format\HtmlFormat::array_escape']('data-status', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'status'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:457
 ?><span<?= (is_bool($_pug_temp = $pugModule['Phug\Formatter\Format\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'badge'], ['class' => 'badge-success'], ['data-status' => $pugModule['Phug\Formatter\Format\HtmlFormat::array_escape']('data-status', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'status'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:461
 ?><?php if (method_exists($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'gender') === 'male', "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(460);
// PUG_DEBUG:460
 ?><i<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'fas'], ['class' => 'fa-mars'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></i><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(463);
// PUG_DEBUG:463
 }  elseif (method_exists($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'gender') === 'female', "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(462);
// PUG_DEBUG:462
 ?><i<?= (is_bool($_pug_temp = $pugModule['Phug\Formatter\Format\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'fas'], ['class' => 'fa-venus'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></i><?php } ?>                </td>
              </tr>
<?php }extract($__eachScopeVariables); ?>            </tbody>
          </table>
        </div>
      </main>
<?php 
...
// PUG_DEBUG:863
 ?>    <script<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('src', $GLOBALS['__jpv_plus_with_ref']($jsAdmin, 'users/users.js'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></script>
  </body>
</html>
