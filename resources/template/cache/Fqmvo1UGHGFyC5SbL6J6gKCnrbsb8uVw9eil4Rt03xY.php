...
// PUG_DEBUG:21
 ?>    <link<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['href' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('href', $GLOBALS['__jpv_plus_with_ref']($cssAdmin, 'users/new.css'))], ['rel' => 'stylesheet'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:412
 ?>          <form<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['action' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('action', $GLOBALS['__jpv_plus_with_ref']($host, '/admin/users/add'))], ['method' => 'post'], ['autocomplete' => 'off'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:372
 ?>                  <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'col-md-6'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(346);
// PUG_DEBUG:346
 ?>                    <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-group'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(344);
// PUG_DEBUG:344
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'firstname'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:345
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'fname'], ['type' => 'text'], ['name' => 'fname'], ['placeholder' => 'Enter your first name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:348
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'lastname'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:349
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'lname'], ['type' => 'text'], ['name' => 'lname'], ['placeholder' => 'Enter your last name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:352
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'username'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:353
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'username'], ['type' => 'text'], ['name' => 'username'], ['placeholder' => 'Enter username'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:356
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'email'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:357
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'email'], ['type' => 'text'], ['name' => 'email'], ['placeholder' => 'Enter your email'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:360
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'gender'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:366
 ?>                      <select<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'gender'], ['name' => 'gender'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:369
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'birthday'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:370
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['class' => 'date'], ['id' => 'birthday'], ['type' => 'text'], ['name' => 'birthday'], ['placeholder' => 'Enter your birthday'], ['autofilee' => true])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
                  </div>
<?php 
...
// PUG_DEBUG:374
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'country'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:379
 ?>                      <select<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'country'], ['name' => 'country'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(375);
// PUG_DEBUG:375
 ?>                        <option<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['value' => ''])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></option>
<?php 
...
// PUG_DEBUG:382
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'state'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:383
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'state'], ['type' => 'text'], ['name' => 'state'], ['placeholder' => 'State name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:386
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'postal-code'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:387
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'postal-code'], ['id' => 'zip'], ['type' => 'number'], ['name' => 'zip'], ['placeholder' => 'Postal Code'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:390
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'city'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:391
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'city'], ['type' => 'text'], ['name' => 'city'], ['placeholder' => 'City name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:394
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'street'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:395
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'street'], ['type' => 'text'], ['name' => 'street'], ['placeholder' => 'Street name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:398
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'hause_number'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:399
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'postal-code'], ['id' => 'house_number'], ['type' => 'number'], ['name' => 'house_number'], ['placeholder' => 'Hause Number'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>                    </div>
<?php 
...
// PUG_DEBUG:402
 ?>                      <label<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['for' => 'additional'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:403
 ?>                      <textarea<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'form-control'], ['id' => 'additional'], ['name' => 'additional'], ['placeholder' => 'More details'], ['rows' => '5'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></textarea>
                    </div>
                  </div>
                </div>
              </div>
...
// PUG_DEBUG:410
 ?>              <div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'card-footer'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(409);
// PUG_DEBUG:409
 ?>                <button<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['class' => 'btn'], ['class' => 'btn-sm'], ['class' => 'btn-primary'], ['type' => 'submit'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:752
 ?>    <script<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\HtmlFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\HtmlFormat::array_escape']('src', $GLOBALS['__jpv_plus_with_ref']($jsAdmin, 'users/new.js'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></script>
  </body>
</html>
